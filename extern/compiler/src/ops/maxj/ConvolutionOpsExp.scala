...
import scala.virtualization.lms.common.{ScalaGenEffect, MaxJGenEffect, MaxJGenFat, ChiselGenEffect, ChiselGenFat}
...
trait ChiselGenConvolutionOps extends ChiselGenEffect with ChiselGenFat {
  val IR: ConvolutionOpsExp with SpatialCodegenOps with UnrolledOpsExp 
  import IR._
